...
Lead with a face, a habit, and something happening nearby. Keep scenes short and specific: seeds, soup, a bent nail, a blocked path. Let humor come from the people. Avoid baby talk, lectures, and jokes that belittle their concerns. Put explanations behind **Why did this happen?**

Current cast hooks and renderer identities:

| Person | Hook | Coat and silhouette |
| --- | --- | --- |
| Nera | Keeps the seeds safe; counts plates before people | Amber `#d2a266`, bun, apron |
| Senn | Talks to seedlings; distrusts neat rows | Leaf green `#9dc58a`, broad hat |
| Ivo | Fixes old things; keeps every bent nail | Clay `#cf9166`, pale beard, tools |
| Tavi | Tidy headings over very untidy notes | Blue `#83bacc`, glasses, notes |
| Daro | Braids mats; believes nobody should eat alone | Rose `#d49b90`, curls, woven reeds |
| Ves | Learning to mend; one question leads to three more | Gold `#e0bd68`, hood |
| Oren | Carries repair plans and unfortunate bridge puns | Slate blue `#93a9c9`, swept hair, pack |
...
Label records **human playtest** or **agent walkthrough**, with device and input method. Separate observations from interpretation. This protocol claims no completed sessions; automated checks cannot establish enjoyment. See [verification](VERIFICATION.md) for evidence and release gaps.
