...
| --- | --- | --- |
| `npm test` — 146 passing | Existing simulation/history suites plus optional courtyard metadata, real channel connectivity, furniture editing, companion choices and twenty-one illustrated/Three.js scene checks | Node execution; renderer input tests use synthetic events |
