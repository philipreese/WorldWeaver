...
| --- | --- | --- |
| `npm test` — 141 passing | Existing simulation/history suites plus optional courtyard metadata, real channel connectivity, furniture editing, companion choices and sixteen illustrated/Three.js scene checks | Node execution; renderer input tests use synthetic events |
